%% Shantam Bajpai
%% Lagrangian Dynamics for 7DOF KUKA LBR iiwa 
%DH Parameters
%Declaring symbolic theta variables as real because matlab by default
%initializes them as complex
...
m1=3.94781; m2=4.50275; m3=2.45520; m4=2.61155; m5=3.41000; m6=3.38795; m7=0.35432;

%Position of the centre of mass for each link
a1c = [-0.00351;0.00160;-0.03139;1]
a2c = [-0.00767;0.16669;-0.00355;1]
a3c = [-0.00225;-0.03492;-0.02652;1]
a4c = [0.00020;-0.05268;0.03818;1]
a5c = [0.00005;-0.00237;-0.21134;1]
a6c = [0.00049;0.02019;-0.02750;1]
a7c = [-0.03466;-0.02324;0.07138;1]
...
%General form of Inertia matrix is:[Ixx Ixy Ixz;Iyx Iyy Iyz;Izx Izy Izz]
I1 = [0.00455 0 -0;0 0.00454 0.00001;0 0.00001 0.00029]
I2 = [0.00032 0.00000 0.00000;0.00000 0.00010 -0.00000;0.00000 -0.00000 0.00042]
...
I5 = [0.00277 -0.00001 0.00001;-0.00001 0.00284 -0.00000;0.00001 -0.00000 0.00012]
I6 = [0.00050 -0.00005 -0.00003;-0.00005 0.00281 -0.00004;-0.00003 -0.00004 0.00232]
...
%P = summation(mi*transpose(g)*(T0i*(position of centre of mass of link)i)
g = [0 0 -9.81]
P1 = m1*(g)*(o01c)
P2 = m2*(g)*(o02c)
P3 = m3*(g)*(o03c)
